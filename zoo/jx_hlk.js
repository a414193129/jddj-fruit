//助力码目前只支持一个
let shareCode = 'be892608e48cd0a7980199026d136ac5';
    ...
    request(
      {
        ...
        headers: {
          ...
          Cookie: cookie,
          accept: '*/*',
          'user-agent':`jdpingou;iPhone;4.8.2;14.5.1;${phoneId};network/wifi;model/iPhone13,4;appBuild/100546;ADID/00000000-0000-0000-0000-000000000000;supportApplePay/1;hasUPPay/0;pushNoticeIsOpen/0;hasOCPay/0;supportBestPay/0;session/318;pap/JA2019_3111789;brand/apple;supportJDSHWK/1;Mozilla/5.0 (iPhone; CPU iPhone OS 14_6 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Mobile/15E148 MicroMessenger/8.0.5(0x18000528) NetType/WIFI Language/zh_CN`,
